...
class Filters(commands.Cog):
    ...
    async def eqflat(self,ctx:commands.Context):
        ...
        try:
            ...
            await ctx.reply("❌ Flat equalizer settings are already enabled.", ephemeral=True)
    ...
    async def eqmetal(self,ctx:commands.Context):
        ...
        try:
            ...
            await ctx.reply("❌ Metal equalizer settings are already enabled.", ephemeral=True)
    ...
    async def eqpiano(self,ctx:commands.Context):
        ...
        try:
            ...
            await ctx.reply("❌ Piano equalizer settings are already enabled.", ephemeral=True)
    ...
    @app_commands.command(name="seteq", description="Manually tune the Auro Engine frequency bands")
    ...
    @app_commands.command(name="eq_help", description="Guide for the Auro Engine frequency bands")
