    ...
    def show_page(self, page_name):
        ...
        if page_name == "Home":
            ...
            container.add_item(ui.TextDisplay(
                ...
                f"**{Emojis.dot} </skipto:1507315810765639743> — Skip directly to a specific track position index inside the queue.\n"
                f"**{Emojis.dot} loop/loopqueue** — Track/Queue repeat toggles.\n"
                f"**{Emojis.dot} </fix:1498209884087521382>** — Hard-reset the Auro Engine.\n"
                f"**{Emojis.dot} </find:1507349747315511347> — Find the position number of a specific song inside the upcoming queue.\n"
                f"**{Emojis.dot} </radio:1499280588191043684>** — 24/7 high-quality streams.\n"
                f"**{Emojis.dot} </rewind:1507339224410619905>** — Replay the track that just finished playing.\n"
